...
class Staging(core.Stack):
    def __init__(self, app: core.App, id: str, props: Dict, **kwargs):
        super().__init__(app, id, **kwargs)

        site_domain = "dashboard-jobbergateapi2-staging.omnivector.solutions"
...
class StagingStage(core.Stage):
    def __init__(
        ...
        **kwargs: Any,
        ...
        stack = Staging(self, f"{props['namespace']}-staging", props, **kwargs)
