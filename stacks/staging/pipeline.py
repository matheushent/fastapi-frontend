...
from stacks.staging.frontend import StagingStage


class StagingPipeline(core.Stack):
    def __init__(self, app: core.App, id: str, props: Dict, **kwargs) -> None:
        ...
        cdk_pipeline.add_application_stage(StagingStage(
